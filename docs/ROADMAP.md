...
| | Feito | Total |
|---|---|---|
| Edge functions **com substituto no backend** | 17 | 73 |
| Edge functions **que o front já parou de chamar** | 13 | 73 |
| Arquivos do front sem Supabase | 13 | 113 |
| Functions distintas ainda referenciadas pelo front | 31 | — |
